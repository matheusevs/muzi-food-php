...
<head>
    ...
    <title>Enzo Food - Matheus Eduardo</title>
    <!-- Fonte -->
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="100">
                            <img src="/public/home-page/img/img-carousel-1.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/public/home-page/img/img-carousel-2.png" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/public/home-page/img/img-carousel.png" class="d-block w-100" alt="...">
                        </div>
                    </div>
